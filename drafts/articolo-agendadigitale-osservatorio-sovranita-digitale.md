---
title: "Tra ciò che si firma e ciò che si costruisce: perché nasce l'Osservatorio"
date: 2026-06-19
...
- Il **46% degli enti** usa provider email soggetti a **giurisdizione extra-UE** (CLOUD Act);
- il **51%** si affida a provider italiani;
- i provider più diffusi sono Google Workspace e Microsoft 365 (insieme circa il 46% del totale).

Il dato diventa ancora più netto guardando i settori: l'**Istruzione** è al **77,7%** su provider statunitensi, la **PA Centrale** al **63,5%**, la **Sanità** al **59,4%** — proprio gli ambiti che trattano i dati più sensibili dei cittadini.
...
Le dichiarazioni si misurano in firme; la sovranità si misura in **dati**. L'Osservatorio fa una cosa semplice e necessaria: **monitoraggio civico**. Misura la dipendenza, la rende pubblica e verificabile, e la consegna a chi può agire — decisori, regolatori, dirigenti PA, ricercatori, giornalisti, società civile. Non per essere contro un fornitore, ma per documentare un fatto: quando la PA affida i propri dati a infrastrutture soggette a giurisdizione extra-UE, cede una parte di controllo sui dati dei cittadini.

I dati sono **aperti** (CC BY-SA 4.0), la metodologia è **documentata e replicabile**, il codice è **open source**. È così che il divario tra il dichiarato e il costruito smette di essere un'opinione e diventa una misura.

## Collabora con noi

L'Osservatorio è un progetto **aperto e multi-stakeholder**, in **versione beta**: ha bisogno del contributo di tutti per crescere.

- **Sviluppatori e tecnici** → migliorate codice, pipeline e qualità del dato su [GitHub](https://github.com/mxmap-it/osservatorio-nazionale-sovranita-digitale).
- **Ricercatori, giornalisti, PA, attivisti** → usate i [dati aperti](/dati-aperti/), segnalate errori, proponete analisi.
...
*Fonti: [avvocatonardini.it](https://avvocatonardini.it/rete-pubblica-sovranita-digitale-italiana/); [Agenda Digitale](https://www.agendadigitale.eu/infrastrutture/sovranita-digitale-litalia-e-la-piu-attendista-dellue-i-fatti/); dati [MxMap.it](https://mxmap.it/) su IndicePA. I valori statistici sono preliminari (progetto in beta) e si aggiornano sul sito.*
